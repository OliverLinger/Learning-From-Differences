...
def train_neural_network_classifier(dev_X, dev_y, preprocessor):
    ...
    # "predictor__early_stopping": [False],
...
def main():
    file_path = r'C:\Users\USER\final_year\fyp\results\classificationImplicit\CarSafetyImplicitResultsBasic.txt'
    df = load_data("datasets/car/car_reduced.csv")
