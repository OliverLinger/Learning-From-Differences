...
def train_knn_regressor_weighted(dev_X, dev_y, preprocessor):
    knn_pipeline = Pipeline([
        ("preprocessor", preprocessor),
...
def save_results(file_path, knn_gs,knn_regressor_gs_weighted, nn_gs, lfd_gs):
    with open(file_path, 'a') as file:
        ...
        file.write(f"Best Parameters weighted KNN regression: {knn_regressor_gs_weighted.best_params_,}\n")
        file.write(f"Best Score weighted KNN regression: {knn_regressor_gs_weighted.best_score_}\n")
...
def calculate_test_accuracies(file_path, knn_gs,knn_regressor_gs_weighted, lfd_gs, nn_gs, test_X, test_y):
    ...
    with open(file_path, 'a') as file:
        ...
        file.write(f"Test Accuracy for weighted KNN regressor: {knn_regressor_gs_weighted_accuracy }\n")
...
def main():
    ...
    knn_regressor_gs_weighted = train_knn_regressor_weighted(dev_X, dev_y, preprocessor)
    ...
    save_results(file_path, knn_gs,knn_regressor_gs_weighted, nn_gs, lfd_gs)
    calculate_test_accuracies(file_path, knn_gs,knn_regressor_gs_weighted, lfd_gs, nn_gs, test_X, test_y)
