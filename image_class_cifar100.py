...
Linger_image_classifier = LingerImageClassifier(n_neighbours_1=5, n_neighbours_2=5)
...
cnn_model.fit(diff_X, diff_y, epochs=3, batch_size=32, validation_split=0.2)

# Use the trained CNN model to make predictions on test data
y_pred = Linger_image_classifier.predict(X_test_cifar, model=cnn_model, dataset="cifar")
