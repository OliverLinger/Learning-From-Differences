...
df = pd.read_csv("datasets/mushrooms/agaricus-lepiota.csv")

# Define the file path
file_path = r'C:\Users\35383\4th_year\fyp\results\MushroomResults.txt'
...
dev_y = dev_df['poisonous'].values
test_y = test_df['poisonous'].values
