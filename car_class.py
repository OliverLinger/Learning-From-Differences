...
df = pd.read_csv("datasets/car/car.csv")

# Define the file path
file_path = r'C:\Users\35383\4th_year\fyp\results\CarSafetyResults.txt'
...
df = df[["Buying", "Maint", "Doors", "Persons", "Lug_boot","Safety", "Class"]]
...
df.dropna(subset=["Buying", "Maint", "Doors", "Persons", "Lug_boot","Safety"], inplace=True)
...
nn_param_grid = {
    "predictor__hidden_layer_sizes": [(64, 32), (128, 64)],
...
lfd_classifier_param_grid = {
    "predictor__n_neighbours_1": [1],
    "predictor__n_neighbours_2": [ 9,],
