...
file_path = r'C:\Users\35383\4th_year\fyp\results\DryBeanResults.txt'
...
df.dropna(subset=['Area', 'Perimeter', 'MajorAxisLength', 'MinorAxisLength',
       'AspectRation', 'Eccentricity', 'ConvexArea', 'EquivDiameter', 'Extent',
       'Solidity', 'roundness', 'Compactness', 'ShapeFactor1', 'ShapeFactor2', 
       'ShapeFactor3', 'ShapeFactor4'], inplace=True)
...
knn_classifier_param_grid = {"predictor__n_neighbors": [19, 20, 21, 22, 23]}
