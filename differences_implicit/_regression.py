...
class LingerImplicitRegressor(BaseEstimator, ClassifierMixin):
    def __init__(
        self,
        n_neighbours_1=5,
        n_neighbours_2=5,
        ...
        """
        Linger ImplicitRegressor is a custom classifier based on k-nearest neighbors and N specialised MLPClassifier.
